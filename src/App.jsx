...
import './App.css';
import lupaImg from './assets/lupa-removebg-preview.png';
import carrinhoImg from './assets/carrinho-removebg-preview.png'
  ...
  return (
    <header>
      ...
      <div className='pesquisa'>
        <img src={lupaImg} alt='lupa' className='lupa' />
        <input
          type='text'
